...
# Student Info
    ...
    Name: Jacqui Unciano
    Net ID: jdu5sq
    File GitHub URL: https://github.com/jacquiunciano/DS5100-jdu5sq/tree/main/lessons/M11/hw11.Rmd
...
df %>%
  group_by(V1) %>%
  summarize("avg_shell_measurement" = mean(V2))
```
...
df %>%
  filter(V1=="M") %>%
  summarise("med_shell_measurement" = median(V2))
```
